// Núcleo de IA de la Personalización (personalize-leads / personalize-batch / process-personalization).
// Vivía en personalize.ts; el 11-09 ese archivo se reescribió para las variables del motor y estas
// tres funciones se quedaron importando exportaciones que ya no existían → "Function failed to
// start" en cada arranque (el cron de process-personalization fallaba cada minuto).
