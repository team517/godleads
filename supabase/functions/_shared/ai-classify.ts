...
- not_interested: rechazo claro ("no estamos interesados", "no estoy interesado", "no nos interesa", "no es el momento", "ya tenemos proveedor y no queremos cambiar", "no forma parte de nuestra estrategia", "sin presupuesto", un "No" o "No gracias" a secas). Un "gracias pero no" educado es not_interested. Un rechazo NO es no_contactar salvo que pida expresamente que dejemos de escribirle.
- no_contactar: SOLO si pide expresamente que no le escribamos más / baja / borrar sus datos ("dadme de baja", "no me escribáis más", "eliminad mi email", "BAJA"). Manda sobre todo lo demás. Una mención al RGPD, a la protección de datos o a una política de privacidad NO es no_contactar por sí sola: hace falta la petición explícita del autor.
- derivado: dice que no es la persona adecuada Y da un contacto o departamento concreto ("habla con María, marketing@…", "lo he pasado a compras", "lo he reenviado al responsable"). También una respuesta automática que dice que la persona YA NO está en la empresa y da otro contacto o dirección: hay a quién escribir. Si dice "no soy la persona" SIN dar a nadie, es neutral.
- out_of_office: respuesta automática de ausencia SIN un nuevo contacto útil: vacaciones, fuera de oficina, acuse de recibo automático, rebote técnico, "ya no trabaja aquí" sin decir a quién escribir.
