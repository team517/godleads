// ⚠️ MIRROR of src/lib/report/buildReportPdf.ts — keep the two IDENTICAL.
// (The frontend can't import from supabase/functions and Deno can't import from src/,
//  so the DOM-free builder is duplicated here for the scheduled send-report path.)
//
...
import type { ReportData, ReportBranding } from "./types.ts";
